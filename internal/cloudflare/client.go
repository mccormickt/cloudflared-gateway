...
const ContainerImage = "cloudflare/cloudflared:latest"
...
func (c *client) CreateTunnel(ctx context.Context, name string, secret []byte) (cf.Tunnel, error) {
	return c.api.CreateTunnel(ctx, c.rc(), cf.TunnelCreateParams{
		Name:      name,
...
// Returns nil, nil if no matching tunnel is found.
...
func (c *client) DeleteTunnel(ctx context.Context, id string) error {
	return c.api.DeleteTunnel(ctx, c.rc(), id)
}
